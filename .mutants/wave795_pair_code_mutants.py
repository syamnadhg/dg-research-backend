...
MUTANTS = [
    ...
    ('U10', CLI, 'over',
     ...
     [('            print("  Its access code changed and the new one did not come back.")', '            print("  Its access code changed — the new one is on the device\'s own screen.")')]),
    ('U11', CLI, 'over',
    ...
    ('U13', SR, 'under',
     ...
     [('"device-remove": "Unlink {name}? It keeps running, but its access code changes — the old one stops working and I’ll show you the new one. Say yes and I’ll remove it.",', '"device-remove": "Unlink {name}? Say yes and I’ll remove it.",')]),
    ('T1', SR, 'over',
    ...
    ('T7', SR, 'over',
     ...
     [('    "invalid_code_format": "Access codes are 8 characters and never use I, L, O, 0 or 1 — check those.",', '    "invalid_code_format": "Access codes are 8 letters/digits (like K7XQ-9B2M) — check the device\'s screen.",')]),
    ('T8', SR, 'over',
    ...
    ('C4', SKILL, 'over',
     ...
     [("- **An access code is the user's to spend — handle it, never repeat it back.** An", '- **A Super Research access code is NOT a secret — NOT a password, credential.** An')]),
    ('C5', SKILL, 'under',
    ...
    ('C6', SKILL, 'over',
     ...
     [('unlinks but the device keeps running on a NEW access code, which the reply shows; sharer just leaves).', 'unlinks but the device keeps running + re-pairs with its code; sharer just leaves).')]),
    ('C7', SKILL, 'over',
